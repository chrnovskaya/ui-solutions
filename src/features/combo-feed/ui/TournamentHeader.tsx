...
/** Шапка турніру. Тап згортає та розгортає блок. */
export function TournamentHeader({ tournament, collapsed, onToggle }: TournamentHeaderProps) {
    return (
        <button
            ...
            className="flex min-h-(--combo-tap-size) w-full cursor-pointer items-center gap-2 rounded-(--combo-row-radius) bg-(--feed-header-bg) px-3 py-2.5 text-left"
        >
